...
SRC = src/main.c src/get_next_line.c src/sl_clean_up.c src/sl_img_utils.c  src/sl_load_textures.c \
	  ...
	  map_valid/bfs.c map_valid/map_checker.c src/sl_render_map.c\
